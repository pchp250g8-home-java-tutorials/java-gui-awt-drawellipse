DrawEllipse. Java tutorials. GUI Application. AWT Library. 2D Graphics.
...
DrawEllipse. Занятия по Java. Приложение с графичкским интерфейсом пользователя. Библиотека AWT 2D Графика.
